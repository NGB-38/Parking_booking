...
//To modify your code so that it displays slots from the selected txtdchooser date to the txtddchooser due date when the "Show" button is clicked, you need to update the Load() method to use both dates for querying the database. Here's how you can do it:
    ...
    private void initComponents() {
        ...
        jLabel10.setBackground(new java.awt.Color(13, 17, 22));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jlblprice, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
//            Date fromDate = (Date) format.parse(fromDateStr);
//            Date dueDate = (Date) format.parse(dueDateStr);
            ...
            if(daysDifference >0){
                ...
                long days = hours / 24;
                long price = days * 20;
             jlblprice.setText(Long.toString(price));
            }
